...
public class BookedTickets extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BookedTickets frame = new BookedTickets();
	...
	public BookedTickets() throws SQLException {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("airline/management/system/icon/viewall.jpg"));
                ...
                ImageIcon i4  = new ImageIcon(ClassLoader.getSystemResource("airline/management/system/icon/viewall.jpg"));
		...
		contentPane.add(table);
                ...
                try{
                    conn c = new conn();
                        String displayCustomersql = "select * from bookticket";
		...
		lblCleanStatus = new JLabel("Phone");
		lblCleanStatus.setBounds(110, 15, 76, 14);
		contentPane.add(lblCleanStatus);
		
		lblNewLabel = new JLabel("ID Type");
		...
		contentPane.add(l5);
                ...
                JLabel l6 = new JLabel("Class Name");
