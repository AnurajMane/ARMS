...
public class Flight_Info extends JFrame{  //Second Frame
    ...
    public Flight_Info(){
        ...
        getContentPane().setFont(new Font("TimesNewRoman", Font.PLAIN, 13));
	...
	Fcode.setFont(new Font("TimesNewRoman", Font.PLAIN, 17));
        Fcode.setBounds(50, 100, 200, 30);
	add(Fcode);
	
		
	JLabel FlightDetails = new JLabel("FLIGHT INFORMATION");
	FlightDetails.setFont(new Font("TimesNewRoman", Font.PLAIN, 31));
	FlightDetails.setForeground(Color.RED);
	FlightDetails.setBounds(50, 20, 570, 35);
	add(FlightDetails);
		
	JButton btnShow = new JButton("SHOW");
	btnShow.setFont(new Font("TimesNewRoman", Font.PLAIN, 20));
	...
	FlightCode.setFont(new Font("TimesNewRoman", Font.PLAIN, 13));
        FlightCode.setBounds(23, 220, 126, 14);
	add(FlightCode);
		
	JLabel FlightName = new JLabel("FLIGHT NAME");
        FlightName.setFont(new Font("TimesNewRoman", Font.PLAIN, 13));
	...
	Capacity.setFont(new Font("TimesNewRoman", Font.PLAIN, 13));
	Capacity.setBounds(497, 220, 111, 14);
	add(Capacity);
		
	JLabel ClassCode = new JLabel("CLASS CODE");
	ClassCode.setFont(new Font("TimesNewRoman", Font.PLAIN, 13));
	ClassCode.setBounds(587, 220, 120, 14);
	add(ClassCode);
		
	JLabel ClassName = new JLabel("CLASS NAME");
	ClassName.setFont(new Font("TimesNewRoman", Font.PLAIN, 13));
