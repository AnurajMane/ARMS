...
public class Passengers extends JFrame {
	...
	public Passengers() throws SQLException {
		...
		contentPane.add(table);
                ...
                try{
                    conn c = new conn();
                        String displayCustomersql = "select * from passenger";
		...
		lblCleanStatus = new JLabel("ADDRESS");
		lblCleanStatus.setBounds(110, 15, 76, 14);
		contentPane.add(lblCleanStatus);
		
		lblNewLabel = new JLabel("NATIONALITY");
		...
		contentPane.add(l3);
                ...
                JLabel l4 = new JLabel("PASSPORT_NO");
		l4.setBounds(620, 15, 90, 14);
		contentPane.add(l4);
                
                JLabel l5 = new JLabel("FLIGHT_CODE");
