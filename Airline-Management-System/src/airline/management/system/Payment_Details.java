...
{ //Fifth
	...
	Show.setFont(new Font("TimesNewRoman", Font.PLAIN, 17));
	...
	Sector.setFont(new Font("TimesNewRoman", Font.BOLD, 31));
	Sector.setBounds(51, 25, 300, 39);
	add(Sector);
	...
	Capacity.setBounds(193, 298, 102, 14);
	add(Capacity);
	...
	Cardno.setFont(new Font("TimesNewRoman", Font.PLAIN, 13));
	Cardno.setBounds(602, 299, 101, 19);
	add(Cardno);
		
	JLabel Phoneno = new JLabel("PHONE_NO");
	Phoneno.setFont(new Font("TimesNewRoman", Font.PLAIN, 13));
