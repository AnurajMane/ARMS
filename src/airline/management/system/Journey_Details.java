...
public class Journey_Details extends JFrame{  //Forth
	...
	Source.setFont(new Font("TimesNewRoman", Font.PLAIN, 19));
	Source.setBounds(40, 100, 150, 27);
	add(Source);
	
        Destination = new JLabel("DESTINATION");
	Destination.setFont(new Font("TimesNewRoman", Font.PLAIN, 19));
	Destination.setBounds(320, 100, 150, 27);
	add(Destination);
		
	
		
	Show = new JButton("SHOW DETAILS");
	Show.setBounds(650, 100, 150, 30);
	add(Show);
	...
	ReservationDetails.setFont(new Font("TimesNewRoman", Font.PLAIN, 31));
	ReservationDetails.setBounds(280, 27, 359, 31);
	add(ReservationDetails);
		
	Pnrno = new JLabel("PNR_NO");
	Pnrno.setFont(new Font("TimesNewRoman", Font.PLAIN, 13));
	Pnrno.setBounds(79, 270, 83, 20);
	add(Pnrno);
		
	Ticketid = new JLabel("TICKET_ID");
	Ticketid.setFont(new Font("TimesNewRoman", Font.PLAIN, 13));
	Ticketid.setBounds(172, 270, 71, 20);
	add(Ticketid);
		
	Fcode = new JLabel("F_CODE");
	Fcode.setFont(new Font("TimesNewRoman", Font.PLAIN, 13));
	Fcode.setBounds(297, 270, 103, 20);
	add(Fcode);
		
	Jnydate = new JLabel("JNY_DATE");
	Jnydate.setFont(new Font("TimesNewRoman", Font.PLAIN, 13));
	Jnydate.setBounds(390, 270, 94, 20);
	add(Jnydate);
		
	Jnytime = new JLabel("JNY_TIME");
	Jnytime.setFont(new Font("TimesNewRoman", Font.PLAIN, 13));
	Jnytime.setBounds(494, 270, 83, 20);
	add(Jnytime);
		
	Source = new JLabel("SOURCE");
	Source.setFont(new Font("TimesNewRoman", Font.PLAIN, 13));
	Source.setBounds(613, 270, 94, 20);
	add(Source);
		
	Destination = new JLabel("DESTINATION");
	Destination.setFont(new Font("TimesNewRoman", Font.PLAIN, 13));
	Destination.setBounds(717, 270, 94, 20);
	add(Destination);
        
	String[] items1 =  {"KOLHAPUR"};
	JComboBox comboBox = new JComboBox(items1);
	comboBox.setBounds(150, 100, 150, 27);
	add(comboBox);
        
	String[] items2 =  {"HYDERABAD", "KOLKATA", "BANGLORE", "MUMBAI", "CHENNAI", "CHANDIGRAH","MANALI"};
	JComboBox comboBox_1 = new JComboBox(items2);
	comboBox_1.setBounds(470, 100, 150, 27);
	add(comboBox_1);
